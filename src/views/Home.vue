  ...
  <div class="ma-0 pa-0">
    <v-row no-gutters>
      ...
      <v-col cols="6" class="text-right">
        <v-btn x-large class="secondary" href="/offendertransfer"
          >New Offender Transfer</v-btn
        >
        <v-btn x-large class="secondary ml-2" href="/schedule"
          >Go to Schedules</v-btn
        >
      </v-col>
    </v-row>
    <v-data-table
        ...
        <v-row>
          ...
          ><v-col cols="7"
            ><v-btn small class="secondary mt-2"
              ><v-icon left>mdi-printer</v-icon>Print All Departing 135's</v-btn
            ></v-col
          >
        </v-row>
      </template>
    ...
    >
      <template v-slot:top>
        <v-row>
          ...
          ><v-col cols="7"
            ><v-btn small class="secondary mt-2"
              ><v-icon left>mdi-printer</v-icon>Print All Arriving 135's</v-btn
            ></v-col
          >
        </v-row>
      </template>
      ...
      <template v-slot:item.preprint135="{ item }">
        <router-link to=""
          >{{ item.preprint135
          }}<v-icon color="primary" class="ml-7"
            >mdi-file-document</v-icon
          ></router-link
        >
      </template>
      ...
      <v-col class="mt-4 text-center" cols="12">
        <span class="overline" style="width: 550px">
          <v-btn @click="syncSOMS" class="mr-2" icon>
            <v-icon x-large>mdi-sync</v-icon> </v-btn
          >Last SOMS Sync:
          <span class="primary--text font-weight-black">2021-05-05 1:22pm</span>
        </span>
      </v-col>
    </v-row>
  </div>
