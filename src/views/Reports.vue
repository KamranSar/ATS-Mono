        ...
        <v-card class="blue-grey lighten-4" min-width="200px" height="100%">
          ...
          <v-row no-gutters>
            ...
            <v-col cols="1" class="mx-4">
              ...
              <v-btn class="blue-grey lighten-4" depressed max-width="36px" style="margin-top: -8px" @click="createPDF135">
      ...
      <v-col cols="12" sm="6" lg="3">
        <v-card class="blue-grey lighten-4" min-width="200px" height="100%">
          <v-card-title style="line-height: 1rem">
            <v-row>
              <v-col>
                <span style="white-space: nowrap">Advance Transfer</span> <span style="white-space: nowrap">Notice</span>
                <br/>
          ...
          <v-row no-gutters>
            ...
            <v-col cols="1" class="mx-4">
              ...
              <v-btn class="blue-grey lighten-4 pa-2" depressed max-width="36px" style="margin-top: -8px" @click="createPDF7344">
                <v-icon large color="primary">mdi-file-pdf</v-icon>
              </v-btn>
            </v-col>
          </v-row>
      ...
      <v-col cols="12" sm="6" lg="3">
        <v-card class="blue-grey lighten-4" min-width="200px" height="100%">
          <v-card-title style="line-height: 1rem">
            <v-row>
              <v-col>
                <span style="white-space: nowrap">Transfer Check</span> <span style="white-space: nowrap">Sheet</span>
                <br/>
          ...
          <v-row no-gutters>
            ...
            <v-col cols="1" class="mx-4">
              <v-btn class="blue-grey lighten-4 pa-2" depressed max-width="36px" style="margin-top: -8px" @click="createPDF134">
                <!-- <v-icon >mdi-printer</v-icon> -->
                <v-icon large color="primary">mdi-file-pdf</v-icon>
              </v-btn>
            </v-col>
        ...
        <v-card class="blue-grey lighten-4" min-width="200px" height="100%">
          ...
          <v-row no-gutters>
            ...
            <v-col cols="1" class="mx-4">
              ...
              <v-btn class="blue-grey lighten-4 pa-2" depressed max-width="36px" style="margin-top: -8px" @click="createPDFBusSeat">
                <v-icon large color="primary">mdi-file-pdf</v-icon>
              </v-btn>
            </v-col>
          </v-row>
            ...
            table: {
              ...
              body: [
                [
                  ...
                  {
                    image: this.writeRotatedText("Slough File / Lifer Packets"),
                    fit: [7, 303],
                    style: "hdrLeft",
                    margin: [2, 20, 2, 2],
                    rowSpan: 4,
                  ...
                  {
                    image: this.writeRotatedText("Discharge File / Microfiche"),
                    fit: [7, 303],
                    style: "hdrLeft",
                    margin: [2, 20, 2, 2],
                    rowSpan: 4,
                  ...
                  {
                    image: this.writeRotatedText("OTC / CCF / WF / DTF Flimsy"),
                    fit: [7, 303],
                    style: "hdrLeft",
                    margin: [2, 20, 2, 2],
                    rowSpan: 4,
        ...
        content: [
          ...
          // =============================
          {
            columns: [
              {
                text:
                  "The inmates listed below will be transferred as indicated.  Please forward alll materials to the case records transfer desk immediately.",
                fontSize: 9,
                margin: [5, 3, 5, 3],
              },
            ],
